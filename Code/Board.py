...
class Board:
    ...
    def clear_one_sanc(self):
        self.score -= self.sanctuaries[len(self.sanctuaries) - 1].calc_score(self)
        self.sanctuaires_dispo.append(self.sanctuaires.pop(len(self.sanctuaries)))
